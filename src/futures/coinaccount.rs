...
impl FuturesCoinAccount {
        ...
        N: Into<Option<String>>,
    {
        ...
        let request = build_signed_request(parameters, self.recv_window)?;
        self.client
            .get_signed(API::FuturesCoin(FuturesCoin::Order), Some(request))
    }
        ...
        N: Into<Option<u16>>,
    {
        ...
        let request = build_signed_request(parameters, self.recv_window)?;
        self.client
            .get_signed(API::FuturesCoin(FuturesCoin::AllOrders), Some(request))
    }
        ...
        N: Into<Option<u16>>,
    {
        ...
        let request = build_signed_request(parameters, self.recv_window)?;
        self.client
            .get_signed(API::FuturesCoin(FuturesCoin::UserTrades), Some(request))
    }
    ...
    pub fn account_information(&self) -> Result<AccountInformation> {
        ...
        let request = build_signed_request(parameters, self.recv_window)?;
        self.client
            .get_signed(API::FuturesCoin(FuturesCoin::Account), Some(request))
    }
            ...
            S: Into<String>,
    {
        ...
        let request = build_signed_request(parameters, self.recv_window)?;
        self.client
            .post_signed(API::FuturesCoin(FuturesCoin::MarginType), request)
    }
    ...
    pub fn get_position_side(&self) -> Result<PositionSideResponse> {
        ...
        let request = build_signed_request(parameters, self.recv_window)?;
        self.client
            .get_signed(API::FuturesCoin(FuturesCoin::PositionSide), Some(request))
    }
    ...
    pub fn get_income(
        ...
        println!("{}", request);
        self.client
            .get_signed(API::FuturesCoin(FuturesCoin::Income), Some(request))
    }
}
